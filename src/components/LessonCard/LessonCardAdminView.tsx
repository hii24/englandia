...
import { LessonCardProps, LessonMaterial } from '.';
...
export const LessonCardAdminView: React.FC<LessonCardProps> = ({ lesson, progress }) => {
      ...
      {open && (
        <div className="lesson-card__body">
          ...
          <div className="lesson-card__admin-actions">
            <button className="lesson-card__action">Редактировать</button>
            <button className="lesson-card__action">Удалить</button>
            <button className="lesson-card__action">Добавить материал</button>
          </div>
        </div>
      )}
    </div>
