...
const allReviews = [
  ...
  // Дополнительные отзывы для функции "Показать больше"
  {
    ...
    text: 'Дочка говорит, что в вашей школе самые интересные занятия:) Ей нравится петь песни, читать сказки и играть в игры с учительницей. Мы заметили, что она разговаривает со своими игрушками на английском языке. Задает им вопросы и сама на них отвечает, как на уроке с учителем.Замечательная школа! Дочка полюбила английский язык и теперь мечтает поехать в Англию. Учителя профессиональные, материал подается в игровой форме.'
  },
  {
    name: 'Дмитрий',
    avatar: '/person-8.jpg',
    childAge: 'сыну 9 лет',
    text: 'Хочу поблагодарить EngLandia за успехи нашего сына. У него были проблемы с чтением в школе. Поэтому преподаватель подтягивала его, прежде всего по звукам и учила читать. Ему очень нравятся ваши комиксы, сказки и истории - очень красочные и интересные! Проблема снята, а мы с удовольствием продолжим заниматься, хотим, чтобы ребенок к моменту окончания школы свободно общался на языке.'
  },
  {
    name: 'Светлана',
    avatar: '/person-9.jpg',
    childAge: 'дочке 12 лет',
    text: 'Дочка обожает заниматься в вашей школе, говорит что “вот бы все занятия по другим предметам, были такими же интересными, а учителя такими добрыми” София любит, когда они с учителем сочиняют истории на английском. На прошлом уроке они написали сказку о принцессе и розовом замке.'
  }
];
